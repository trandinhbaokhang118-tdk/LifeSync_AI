...
export function OperationsAnalytics() {
  ...
  return <div className="admin-records ops-page">
    <header className="records-heading"><div><h1 className="admin-title">Thời gian & thể thao</h1><p className="admin-title-sub">Toàn hệ thống · 14 ngày gần nhất · múi giờ Việt Nam</p></div><button className="admin-btn admin-btn-primary" disabled={query.isFetching} onClick={() => query.refetch()}><RefreshCw size={16} />{query.isFetching ? 'Đang tải...' : 'Cập nhật'}</button></header>
